        ...
        <div className={"flex flex-nowrap items-center justify-center h-fit p"}>
            ...
            <div className={"w-[1000px] h-fit mt-28"}>
                ...
                <div className={"mt-32"}>
                    ...
                    <p className={"text-xs text-gray-500 pl-5"}>Python, SQL, Discord API, Google Cloud Translation API, GPT-4 API</p><br />
                    ...
                    <p className={"text-xs text-gray-500 pl-5"}>Web Sockets (socket.io), Next.js, React, Redis, MUI</p><br />
